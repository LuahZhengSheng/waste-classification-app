...
class FTextTheme {
  ...
  static TextTheme lightTextTheme = TextTheme(
    ...
    labelMedium: const TextStyle().copyWith(fontSize: 12.0, fontWeight: FontWeight.w600, color: Colors.black.withOpacity(0.5)),
  );

  /// -- Dark Theme
  static TextTheme darkTextTheme = TextTheme(
    headlineLarge: const TextStyle().copyWith(fontSize: 32.0, fontWeight: FontWeight.normal, color: Colors.white),
    ...
    labelMedium: const TextStyle().copyWith(fontSize: 12.0, fontWeight: FontWeight.w600, color: Colors.white.withOpacity(0.5)),
  );
}