...
import 'widgets/staff_actions_dialog.dart';
...
class StaffManagementScreen extends StatelessWidget {
              ...
              children: [
                ...
                Obx(() => Row(
                  children: [
                    _buildFilterTab(
                      'Active Staff',
                      isActive: controller.currentFilter.value == StaffFilter.active,
                      onTap: () => controller.changeFilter(StaffFilter.active),
                      dark: dark,
                    ),
                    const SizedBox(width: FSizes.sm),
                    _buildFilterTab(
                      'Inactive Staff',
                      isActive: controller.currentFilter.value == StaffFilter.inactive,
                      onTap: () => controller.changeFilter(StaffFilter.inactive),
                      dark: dark,
                    ),
                    const SizedBox(width: FSizes.sm),
                    _buildFilterTab(
                      'Banned Staff',
                      isActive: controller.currentFilter.value == StaffFilter.banned,
                      onTap: () => controller.changeFilter(StaffFilter.banned),
                      dark: dark,
                    ),
                  ],
                )),
                ...
                // Create Staff Button
                ElevatedButton.icon(
                  onPressed: () => _showCreateStaffDialog(context, dark),
                  ...
                  child: Container(
                    ...
                    child: TextField(
                      ...
                      decoration: InputDecoration(
                        hintText: 'Search by username, email, center ID...',
                        hintStyle: TextStyle(
                    ...
                    children: [
                      Expanded(
                        child: StaffDataTable(
                          staff: controller.paginatedStaff,
                          onSort: controller.sortStaff,
                          sortColumnIndex: controller.sortColumnIndex.value,
                          sortAscending: controller.sortAscending.value,
                          dark: dark,
                          isBannedView: controller.currentFilter.value == StaffFilter.banned,
                        ),
                      ),
  ...
  Widget _buildPagination(StaffManagementController controller, bool dark) {
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          Text(
            'Showing ${controller.startIndex + 1} to ${controller.endIndex} of ${controller.totalStaff} entries',
            style: TextStyle(
              color: dark ? FColors.adminDarkTextSecondary : FColors.adminLightTextSecondary,
            ),
          ),
  ...
  void _showFilters(BuildContext context, StaffManagementController controller, bool dark) {
    Get.dialog(
      StaffFilterDialog(
        dark: dark,
  ...
  void _showCreateStaffDialog(BuildContext context, bool dark) {
    Get.dialog(
      CreateStaffDialog(dark: dark),
      barrierDismissible: false,
    );
  }
}